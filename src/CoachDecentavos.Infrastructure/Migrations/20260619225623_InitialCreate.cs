    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_youtube_shorts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_oauth_accounts_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_content_translations_EntityType_EntityId_Locale_FieldKey",
                table: "content_translations",
                columns: new[] { "EntityType", "EntityId", "Locale", "FieldKey" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_oauth_accounts_Provider_ProviderUserId",
                table: "user_oauth_accounts",
                columns: new[] { "Provider", "ProviderUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_user_oauth_accounts_UserId",
                table: "user_oauth_accounts",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_youtube_shorts_VideoId",
